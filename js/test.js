    ...
    base.methods = {
      init: function() {
        ...
        $(document).on("click", startButton, function(e) {
          ...
          base.countDownDate = currentDate.setMinutes(
            currentDate.getMinutes() + base.duration
          );
          base.timer = setInterval(base.methods.startTimer, 1000);
        });
        ...
        $(document).on("click", "#quiz-restart-btn, #quiz-retry-btn", function(
          e
        ) {
          e.preventDefault();
          var currentDate = new Date();
      ...
      startTimer: function() {
        ...
        var distance = base.countDownDate - now;
...
var testData = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ["DISP, PORT", "MODEM, ADAPTER."],
      correctIndex: 0,
      correctResponse: congratulation,
      incorrectResponse: wrongAnswer
    },
    ...
    },
    {
      ...
      options: ["командный", "системный", "выполняемый."],
      correctIndex: 2,
      correctResponse: congratulation,
      incorrectResponse: wrongAnswer
    },
    ...
    },
    {
      ...
      options: ["имена и расширения", "имена и расширения", "обычные имена."],
      correctIndex: 2,
      correctResponse: congratulation,
      incorrectResponse: wrongAnswer
    },
    ...
    },
    {
      ...
      options: ["ab+bcd.e", "abc.txtd", "abc.txt"],
      correctIndex: 2,
      correctResponse: congratulation,
      incorrectResponse: wrongAnswer
    }
